...
<x-app-layout>
    <div class="w-[80%] mx-auto px-4 py-6">
        ...
        <div class="mb-6 flex items-center gap-4">
            <a href="{{ route('course.manage-quiz', ['course' => $quiz->course_id]) }}"
            ...
            <div>
                <h1 class="text-3xl font-bold text-[#3bcbbe]">Edit Quiz Question</h1>
                <p class="text-sm text-gray-600 mt-0.5">Update quiz question details</p>
            </div>
        </div>
        ...
        <div class="bg-white border border-[#3bcbbe] overflow-hidden shadow-md rounded-2xl">
            ...
            <div class="p-6">
                <form id="quiz-form" action="{{ route('course.quiz.update', ['quiz' => $quiz]) }}" method="post"
                    class="space-y-5">
                    @csrf
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <textarea name="question" cols="30" rows="2" placeholder="Write Question" required
                                class="resize-none w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#3bcbbe] focus:border-[#3bcbbe] focus:bg-white transition-all text-sm placeholder:text-gray-400 shadow-sm hover:border-[#3bcbbe]/50">{{ $quiz->question }}</textarea>
                            @error('question')
                                <span class="text-red-600 text-xs font-medium mt-1.5 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <textarea name="option_a" data-option="a" cols="30" rows="2" placeholder="Write Option A"
                                class="options resize-none w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#3bcbbe] focus:border-[#3bcbbe] focus:bg-white transition-all text-sm placeholder:text-gray-400 shadow-sm hover:border-[#3bcbbe]/50">{{ $quiz->option_a }}</textarea>
                            @error('option_a')
                                <span class="text-red-600 text-xs font-medium mt-1.5 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                        ...
                        <div>
                            ...
                            <textarea name="option_b" data-option="b" cols="30" rows="2" placeholder="Write Option B"
                                class="options resize-none w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#3bcbbe] focus:border-[#3bcbbe] focus:bg-white transition-all text-sm placeholder:text-gray-400 shadow-sm hover:border-[#3bcbbe]/50">{{ $quiz->option_b }}</textarea>
                            @error('option_b')
                                <span class="text-red-600 text-xs font-medium mt-1.5 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <textarea name="option_c" data-option="c" cols="30" rows="2" placeholder="Write Option C"
                                class="options resize-none w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#3bcbbe] focus:border-[#3bcbbe] focus:bg-white transition-all text-sm placeholder:text-gray-400 shadow-sm hover:border-[#3bcbbe]/50">{{ $quiz->option_c }}</textarea>
                            @error('option_c')
                                <span class="text-red-600 text-xs font-medium mt-1.5 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                        ...
                        <div>
                            ...
                            <textarea name="option_d" data-option="d" cols="30" rows="2" placeholder="Write Option D"
                                class="options resize-none w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#3bcbbe] focus:border-[#3bcbbe] focus:bg-white transition-all text-sm placeholder:text-gray-400 shadow-sm hover:border-[#3bcbbe]/50">{{ $quiz->option_d }}</textarea>
                            @error('option_d')
                                <span class="text-red-600 text-xs font-medium mt-1.5 flex items-center gap-1">
                                    <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd"
                    ...
                    <div>
                        ...
                        <textarea name="description" cols="30" rows="4" placeholder="Write Description"
                            class="resize-none w-full bg-gray-50 border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-[#3bcbbe] focus:border-[#3bcbbe] focus:bg-white transition-all text-sm placeholder:text-gray-400 shadow-sm hover:border-[#3bcbbe]/50">{{ $quiz->description }}</textarea>
                        @error('description')
                            <span class="text-red-600 text-xs font-medium mt-1.5 flex items-center gap-1">
                                <svg class="w-3.5 h-3.5" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd"
