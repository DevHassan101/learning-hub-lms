...
<x-app-layout>
    <div class="w-[80%] mx-auto px-4 py-6">
        ...
        <div class="mb-6 flex items-center gap-4">
            ...
            <div>
                <h1 class="text-3xl font-bold text-[#3bcbbe]">Add New Question</h1>
                <p class="text-sm text-gray-600 mt-0.5">Create a new exam question</p>
            </div>
        </div>
        ...
        <div class="bg-white border border-[#3bcbbe] overflow-hidden shadow-md rounded-2xl">
            ...
            <div class="p-6">
                <form id="exam-form" action="{{ route('course.exam.store', ['course' => $course]) }}" method="post"
                    class="space-y-5">
                    @csrf
