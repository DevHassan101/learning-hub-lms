                            ...
                            <tr class="border-b border-gray-100 hover:bg-gradient-to-r hover:from-purple-50/30 hover:to-indigo-50/30 transition-all duration-200">
                                ...
                                <td class="text-sm px-4 py-4">
                                    <div class="flex justify-center items-center gap-2">
                                        <a href="{{ route('flash-card.edit', ['flash_card' => $flashCard]) }}" class="group relative" title="Edit Flash Card">
                                        ...
                                        <button type="button" class="delete-flash-card group relative" data-id="{{ $flashCard->id }}" title="Delete Flash Card">
                        ...
                        <tr>
                            <td colspan="4" class="py-12">
                                <div class="flex flex-col justify-center items-center">
                                    ...
                                    <p class="text-gray-500 font-medium text-lg">No flash cards found</p>
