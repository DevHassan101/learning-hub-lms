                    ...
                    @forelse ($categories as $category)
                        <tr class="border-b border-[#102935]">
                            <td class="text-[16px] font-regular text-center text-nowrap p-3">{{ $category->title }}
                            </td>
                            ...
                            <td class="text-[16px] font-regular py-3 text-center">
                                <div class="flex justify-center">
                                    <a href="{{ route('program.edit', ['program' => $category]) }}" class="{{$category->title == 'NCLEX & IELTS' ? '' : 'mx-2' }}">
