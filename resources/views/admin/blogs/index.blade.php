                ...
                <tbody id="myTable">
                    @forelse ($blogs as $blog)
                        <tr class="border-b border-gray-100 hover:bg-gradient-to-r hover:from-purple-50/30 hover:to-indigo-50/30 transition-all duration-200">
                            <td class="text-sm font-medium text-gray-800 text-left px-6 py-4">
                            ...
                            <td class="text-sm text-gray-600 text-left px-4 py-4">
                                {{ substr($blog->description, 0, 120) }}
                                {{ strlen($blog->description) > 120 ? '...' : '' }}
                            </td>
                            <td class="text-sm px-4 py-4">
                                <div class="flex justify-center items-center gap-2">
                                    <a href="{{ route('blog.edit', ['blog' => $blog]) }}" class="group relative" title="Edit Blog">
                                    ...
                                    <button type="button" class="delete-blog group relative" data-id="{{ $blog->id }}" title="Delete Blog">
                        ...
                        <tr>
                            <td colspan="3" class="py-12">
                                <div class="flex flex-col justify-center items-center">
                                    ...
                                    <p class="text-gray-500 font-medium text-lg">No blogs found</p>
