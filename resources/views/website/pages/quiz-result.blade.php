...
<section class="min-h-screen py-10 px-5 lg:p-20 w-full bg-gray-50">
    ...
    <div class="max-w-5xl mx-auto bg-white border-2 border-[#3bcbbe] rounded-2xl shadow-lg p-10 grid md:grid-cols-2 gap-10">
        ...
        <!-- Result Summary -->
        <div>
            <h2 class="text-3xl font-bold text-[#102935] mb-6">Quiz Result</h2>

            <!-- Score Badge -->
            <div class="mb-8">
                <div class="inline-flex items-center justify-center w-36 h-36 rounded-full bg-gradient-to-r from-[#3bcbbe] to-[#26beb1] text-white shadow-lg">
            ...
            @if ($userQuiz->type == 'time restricted')
                <div class="mb-6">
                    ...
                    <p class="text-xl font-semibold text-[#102935]">{{ $userQuiz->time_spent }} seconds</p>
                </div>
            @endif
            ...
            <div class="mb-10">
                @if($percentage >= 80)
                    ...
                    <p class="text-gray-600">You have mastered this topic.</p>
                @elseif($percentage >= 50)
                    <h4 class="text-2xl font-bold text-yellow-600">Good Attempt</h4>
                    <p class="text-gray-600">A little more practice will improve your score.</p>
                @else
                    <h4 class="text-2xl font-bold text-red-600">Needs Improvement</h4>
                    <p class="text-gray-600">Review the material and try again.</p>
                @endif
            </div>
